 ...
 * @Author : fengx9
 * @Project : new-mall
 * @Date : Created in 2024-01-03 15:56
 */
...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public PagedGridResult<SearchItemsVO> searhItems(String keywords, String sort, Integer page, Integer pageSize) {
        Map<String, Object> map = new HashMap<>();
    ...
    public void decreaseItemSpecStock(String specId, int buyCounts) {
        ...
        if (result != 1) {
            log.error("库存不足，specId={}, byCounts={}", specId, buyCounts);
            throw new BaseRunTimeException(ExceptionEnum.STOCK_DEFICIENCY_EXCEPTION);
        }
    }
    ...
    private <T> PagedGridResult<T> setterPagedGrid(List<T> list, Integer page) {
